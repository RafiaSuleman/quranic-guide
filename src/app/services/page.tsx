  ...
  <div className="container px-5 py-24 mx-auto ">
    ...
    <div className="flex flex-wrap -m-4 text-center">
      ...
      <div className="md:w-1/4 sm:w-1/2 w-full">
        <div className="border-2 border-green-600  py-6 rounded-lg transform transition duration-500 hover:scale-110">
          {/* <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="text-indigo-500 w-20 h-12 mb-3 inline-block" viewBox="0 0 24 24">
            <path d="M8 17l4 4 4-4m-4-5v9"></path>
            <path d="M20.88 18.09A5 5 0 0018 9h-1.26A8 8 0 103 16.29"></path>
          </svg> */}
          <Image src="/tajweed.png" className="ml-3 flex justify-center items-center fully-rounded" height={10} width={90} alt="tajweed"/>
          <h2 className="title-font font-medium text-3xl text-gray-900">Tajweed</h2>
        </div>
      </div>
      <div className="p-5 md:w-1/4 sm:w-1/2 w-full">
        <div className="border-2 border-green-600 px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110">
          ...
          <Image src="/nazra.png"height={90} width={250} alt='nazra pic'/>
      ...
      <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
        <div className="border-2 border-green-600 px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110">
          ...
          <Image src="/hifz.png"height={90} width={400} alt='nazra pic'/>
